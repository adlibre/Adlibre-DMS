...
urlpatterns = patterns('mdtui.views',
    ...
    # Indexing Edit
    url(r'^indexing/edit/(?P<code>[\w_-]+)$', 'edit', {'step': 'edit'}, name='mdtui-edit'),
    url(r'^indexing/edit_type/(?P<code>[\w_-]+)$', 'edit_type', {'step': 'edit_type'}, name='mdtui-edit-type'),
    url(r'^indexing/edit_revisions/(?P<code>[\w_-]+)$', 'edit_file_revisions', {'step': 'edit_revisions'}, name='mdtui-edit-revisions'),
    url(r'^indexing/edit_delete/(?P<code>[\w_-]+)$', 'edit_file_delete', name='mdtui-edit-delete'),
    url(r'^indexing/edit_finished$', 'edit_result', {'step': 'edit_finish'}, name='mdtui-edit-finished'),
    # Common
